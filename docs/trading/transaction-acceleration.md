...
| **收款账户** | `7HkiWXe5deJvzn4D6kgMUFCADwX9Z4DMrdjNSSxN6bPp` |
...
const TIPS_ACCOUNT = new PublicKey("7HkiWXe5deJvzn4D6kgMUFCADwX9Z4DMrdjNSSxN6bPp");
...
- **鉴权**：仅支持 API Key，若用户仅有 x402 钱包，需引导注册 ZAN 账户
- **测试网**：目前不支持测试网
